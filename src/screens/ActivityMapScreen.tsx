...
export const ActivityMapScreen = ({ onNavigate }: { onNavigate: (screen: string) => void }) => {
  ...
  const startTracking = async () => {
    ...
    setDistanceKm(0); setDurationSec(0); setCalories(0); setIsTracking(true); setAiInsight(null); setRouteCoordinates([]);
  ...
  return (
    <View style={styles.container}>
      ...
      >
        <Polyline coordinates={routeCoordinates} strokeColor={S_COLORS.accentSecondary} strokeWidth={6} lineCap="round" lineJoin="round" />
      </MapView>
...
const styles = StyleSheet.create({
  ...
  mainDistance: { fontFamily: 'Poppins_700Bold', fontSize: 48, color: S_COLORS.text, lineHeight: 52, letterSpacing: -1, fontVariant: ['tabular-nums'] },
  mainLabel: { fontFamily: 'Poppins_600SemiBold', fontSize: 13, color: S_COLORS.textDim, textTransform: 'uppercase', letterSpacing: 1 },
  ...
  aiLoaderText: { fontFamily: 'Poppins_500Medium', color: S_COLORS.textDim, fontSize: 13 },
  ...
  aiInsightText: { fontFamily: 'Poppins_400Regular', color: S_COLORS.text, fontSize: 13, lineHeight: 18 },
  ...
  actionButtonText: { fontFamily: 'Poppins_700Bold', color: '#FFFFFF', fontSize: 15, letterSpacing: 1 },
});
